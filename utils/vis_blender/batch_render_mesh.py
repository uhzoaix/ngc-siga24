...
def render_mesh(mesh_file, mat, output_folder):
    ...
    # mesh.rotation_euler[0] = -np.pi / 3
    mesh.rotation_euler[1] = np.pi * 0.5

    img_file = op.join(output_folder, f'{name}.png')
